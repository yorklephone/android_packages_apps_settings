...
public class DisplaySettings extends PreferenceActivity implements
    ...
    private static final String KEY_PROXIMITY_SENSOR = "proximity_sensor";

    private ListPreference mAnimations;
    private CheckBoxPreference mAccelerometer;
    private float[] mAnimationScales;
    private CheckBoxPreference mProximitySensor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProximitySensor = (CheckBoxPreference) findPreference(KEY_PROXIMITY_SENSOR);
        mProximitySensor.setPersistent(false);
    ...
    private void updateState(boolean force) {
        ...
        mProximitySensor.setChecked(Settings.System.getInt(
                getContentResolver(),
                Settings.System.PROXIMITY_SENSOR_ENABLED, 1) != 0);
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (preference == mProximitySensor) {
            Settings.System.putInt(getContentResolver(),
                    Settings.System.PROXIMITY_SENSOR_ENABLED,
                    mProximitySensor.isChecked() ? 1 : 0);
        }
        return true;
    }
