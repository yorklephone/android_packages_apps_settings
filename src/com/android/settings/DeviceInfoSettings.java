...
public class DeviceInfoSettings extends PreferenceActivity {
    ...
    private static final String PROPERTY_URL_BASEBAND_VERSION = "gsm.version.baseband";

    long[] mHits = new long[3];
    public static final String DEVICE_TYPE     = "ro.product.device";
    public static final String DEVICE_WCDMA    = "lephone_001w";
    public static final String DEVICE_WCDMA_2  = "lephone_002w";
    public static final String DEVICE_EVDO_2   = "lephone_002e";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        findPreference("baseband_version").setSummary(getBasebandVersion());
    ...
    private static String getDeviceTypeStr() {
        return SystemProperties.get(DEVICE_TYPE, "");
    }

    private String getBasebandVersion(){
        if(DEVICE_WCDMA.equals(getDeviceTypeStr()))
            return "33761";
        if(DEVICE_WCDMA_2.equals(getDeviceTypeStr()))
            return "35961";
        if(DEVICE_EVDO_2.equals(getDeviceTypeStr()))
            return "37361";
        else
            return "37361";
    }
